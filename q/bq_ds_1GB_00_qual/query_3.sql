...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-06' as date) 
                  and DATE_ADD(cast('2000-08-06' as date), interval 14 day)
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '50824','26514','95925','50356','25724','66692',
                          '44725','83824','69431','35969','33836',
                          '48520','59913','24554','76654','25287',
                          '67258','64915','74178','38656','24571',
                          '20191','32296','84198','13364','16893',
                          '11056','85984','38377','28717','47535',
                          '79786','84660','12046','30215','22625',
                          '50242','92008','59470','21114','88753',
                          '19387','14932','36999','13658','28087',
                          '12020','56338','21132','74762','85658',
                          '40311','40293','23348','89688','71076',
                          '78981','70840','90414','84535','91196',
                          '22194','39413','99189','45544','27471',
                          '58810','10182','16626','86052','94410',
                          '11602','36899','64557','76439','17372',
                          '44020','61369','50347','12598','62621',
                          '41361','16609','28511','46042','59692',
                          '86452','89331','47063','29984','66860',
                          '19883','11228','23235','67400','11598',
                          '85266','41270','99895','74381','46383',
                          '90753','99519','20473','70652','13930',
                          '72599','18331','38709','24354','12253',
                          '18263','95909','39032','13571','35526',
                          '54975','87247','98594','83792','97339',
                          '53923','51842','65992','56551','80155',
                          '25734','48845','30104','80745','10370',
                          '55466','43401','15421','63327','32447',
                          '26422','61755','93566','74154','58554',
                          '52718','80219','76701','60423','44588',
                          '34488','49174','61175','89246','84512',
                          '89035','42185','80697','88343','30732',
                          '30987','16306','53115','58326','47579',
                          '41019','25308','59451','30276','90155',
                          '66969','70571','62702','56766','83597',
                          '47153','20335','28045','54118','54009',
                          '77996','24362','35452','36597','11649',
                          '12414','69200','41352','68025','55885',
                          '99939','32077','24900','87967','54110',
                          '15665','81487','68954','65973','14020',
                          '75128','55065','99286','67840','16614',
                          '34891','99967','77191','11916','26467',
                          '79582','77406','18896','73689','96467',
                          '85228','95530','47752','85224','12268',
                          '70542','96929','76367','87530','50169',
                          '90190','52560','59057','16098','49065',
                          '56873','74768','42380','43789','88386',
                          '48771','77563','21922','87554','53874',
                          '87474','62643','19140','46672','59064',
                          '88447','20346','53603','16153','85720',
                          '33161','97999','72736','73577','45987',
                          '79488','83487','65497','32370','61102',
                          '56033','61028','93722','74370','94080',
                          '21045','89259','63549','23091','93423',
                          '79142','32900','81079','11581','98318',
                          '91069','21107','27500','57443','90230',
                          '36865','72177','70680','37531','79481',
                          '19440','45356','17748','40551','88434',
                          '31906','87350','32204','78748','37259',
                          '25672','72361','51478','60010','65744',
                          '72878','52200','77238','86841','92592',
                          '61416','66925','54369','30585','36428',
                          '55783','32536','22502','18414','31754',
                          '69274','45349','79639','68786','44414',
                          '93260','88257','23809','45777','35193',
                          '23873','21470','24844','30882','19191',
                          '14956','37647','86845','38234','63854',
                          '30173','16712','76761','56316','76151',
                          '11858','95633','25284','79131','56683',
                          '32718','72023','50778','69798','55988',
                          '14003','74932','56964','18945','95890',
                          '37944','31530','17693','52744','63349',
                          '85045','57679','98746','99580','36503',
                          '52425','10134','23082','63613','29548',
                          '99443','66341','15484','40560','32989',
                          '85340','75115','13231','84706','75046',
                          '26213','98165','57520','53485','26047',
                          '56967','16776','86531','14955','56061',
                          '61552','85354','80100','88093','80461',
                          '28587','32556','72627','37736','49577',
                          '99285','33629','21976','95731')
     intersect distinct
      select ca_zip
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 38659
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 42435
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 23447
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 32073
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 10186
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
select  
 ...
 where
  ...
  ca_county in ('Deuel County','Kewaunee County','Nodaway County','Schoharie County','Noble County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (5,7,11,4,8,2) and
       d_year = 2001 and
       ca_state in ('GA','NV','AR'
                   ,'NY','KY','VT','MS')
...
select  i_item_id
 ...
 and d_date between cast('2001-04-13' as date) 
        and date_add(cast('2001-04-13' as date), interval 30 day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between date_sub(cast ('1998-02-06' as date), interval 30 day)
                    and date_add(cast ('1998-02-06' as date), interval 30 day)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 181 and 181+10 
             or ss_coupon_amt between 15660 and 15660+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 104 and 104+10
          or ss_coupon_amt between 9349 and 9349+1000
...
and d_date between '1999-01-30' and 
        date_add(cast('1999-01-30' as date), interval 90 day)
...
select  i_item_id
 ...
 and d_date between cast('2002-04-11' as date) and date_add(cast('2002-04-11' as date), interval 60 day)
 and i_manufact_id in (876,771,979,981)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between date_sub(cast ('1999-03-28' as date), interval 30 day)
                and date_add(cast ('1999-03-28' as date), interval 30 day) 
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 888 and 888+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'grey' or i_color = 'ivory') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('purple','navajo','ivory'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 6
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('firebrick','steel','navajo','papaya','burlywood','lavender') and
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 8780 and 8780+28800 
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-29' as date) 
                  and date_add(cast('2001-08-29' as date), interval 30 day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-28' as date) 
                  and date_add(cast('1999-08-28' as date), interval 30 day)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-02-04' as date) and date_add(cast('2000-02-04' as date), interval 60 day)
 and i_manufact_id in (525,903,261,597)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-01-21','1999-09-06','1999-11-08')))
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Glenwood'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  24238
   and ib_upper_bound   <=  24238 + 50000
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Children','Music','Books') and
          i_class in ('toddlers','rock','travel')
         )
      or (i_category in ('Jewelry','Men','Sports') and
          i_class in ('gold','sports-apparel','guns') 
        ))
...
and d_date between '1999-01-06' and 
        date_add(cast('1999-01-06' as date), interval 90 day)
...
where 
	...
	and d_date between cast('1999-04-17' as date)
        and date_add(cast('1999-04-17' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
