...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-17' as date) 
                  and DATE_ADD(cast('1998-08-17' as date), interval 14 day)
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '14412','39599','23814','99492','90589','18891',
                          '33009','71119','97587','30557','60685',
                          '88444','26297','49390','22919','86252',
                          '15361','90113','76445','94325','43623',
                          '63911','86250','38540','60941','96066',
                          '86492','84511','46139','17420','20653',
                          '22804','39193','59796','31598','48080',
                          '96880','22393','77193','23005','84170',
                          '83898','49429','12266','29272','72049',
                          '82469','48276','37461','49250','65350',
                          '30845','39362','40402','91309','56220',
                          '83458','39026','92774','89388','94268',
                          '49471','99967','57887','82645','15732',
                          '54767','67737','72061','68009','89794',
                          '90774','43874','17973','35404','87822',
                          '57803','71295','98376','29602','42135',
                          '42399','65400','44956','11253','83101',
                          '10579','88306','26867','96560','19843',
                          '60242','24236','85251','94114','89965',
                          '25999','88901','16171','68690','49727',
                          '48240','84939','53217','84823','10678',
                          '67568','33768','91631','45049','46016',
                          '19841','59692','35173','83108','69544',
                          '89767','36620','80840','58821','94218',
                          '56363','16812','33727','33428','21750',
                          '32382','85466','58109','13255','84804',
                          '13102','55693','47038','49439','86095',
                          '36090','97564','14558','21326','15160',
                          '15946','25838','37644','82510','50403',
                          '11324','82483','25930','23883','23525',
                          '39936','96949','22355','66019','23206',
                          '24196','47529','36921','72554','71401',
                          '79880','47855','97388','25204','85202',
                          '52545','83969','73419','24907','81517',
                          '15277','67917','27399','61065','94703',
                          '63511','11269','55548','82011','48566',
                          '76095','60985','21194','36546','82308',
                          '49115','92618','50033','50639','30406',
                          '73603','45495','67319','84927','40104',
                          '97262','57040','35425','84427','13421',
                          '69930','21032','19204','16005','51784',
                          '39683','53814','85682','35552','33725',
                          '58975','92653','32675','76551','45938',
                          '64889','51342','49421','27195','47511',
                          '64471','45120','39605','72338','36342',
                          '51733','42055','46439','51470','46498',
                          '65693','41118','90042','25153','24910',
                          '80614','95121','85889','87598','71469',
                          '92800','56019','71282','18352','82657',
                          '89694','64708','90430','16595','27175',
                          '64211','94844','57035','20943','48403',
                          '61578','40523','21449','78797','52583',
                          '81816','90033','33228','15814','49159',
                          '92762','47607','31319','78798','43238',
                          '38417','51621','56483','46539','35478',
                          '92247','68707','17364','59253','91818',
                          '62023','72658','99669','10734','61668',
                          '74823','71834','59087','84689','35018',
                          '70332','23300','23163','20547','31882',
                          '85950','78090','54635','99664','15515',
                          '70699','51159','77021','14238','56878',
                          '52705','54304','47890','19609','31031',
                          '74043','70715','58317','13103','14264',
                          '62799','27240','88062','32664','96871',
                          '67136','18313','32721','62798','91538',
                          '24675','63114','68063','45836','33447',
                          '23836','28917','20463','52299','35293',
                          '90915','50336','49423','63644','34699',
                          '29713','33944','86787','21779','37383',
                          '58086','86505','25656','98359','75493',
                          '18661','46392','91789','83526','96961',
                          '66207','84850','75618','45255','60896',
                          '26333','84103','58541','40058','25409',
                          '46212','36558','41314','69517','11921',
                          '92167','39824','20310','92869','44599',
                          '98781','68436','54745','78679','49331',
                          '39789','35811','77587','40642','78296',
                          '64389','12321','77699','61719','98650',
                          '26630','36187','47315','77319','52729',
                          '67402','93148','41157','81866')
     intersect distinct
      select ca_zip
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 6496
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 46203
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 35213
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 6386
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 37169
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
select  
 ...
 where
  ...
  ca_county in ('Cole County','Owyhee County','Park County','Brooke County','Hardin County') and
...
where 
	...
	and d_date between cast('2001-06-26' as date) 
        and date_add(cast('2001-06-26' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('IN', 'AR', 'SD')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TN', 'MD', 'ID')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NC', 'MS', 'GA')
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (12,5,11,10,3,8) and
       d_year = 2001 and
       ca_state in ('MD','KS','PA'
                   ,'TX','OR','TN','MO')
...
select  i_item_id
 ...
 and d_date between cast('2001-02-21' as date) 
        and date_add(cast('2001-02-21' as date), interval 30 day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between date_sub(cast ('1999-02-11' as date), interval 30 day)
                    and date_add(cast ('1999-02-11' as date), interval 30 day)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 140 and 140+10 
             or ss_coupon_amt between 8025 and 8025+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 22 and 22+10
          or ss_coupon_amt between 4033 and 4033+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 137 and 137+10
          or ss_coupon_amt between 11571 and 11571+1000
...
and d_date between '1998-03-20' and 
        date_add(cast('1998-03-20' as date), interval 90 day)
...
select  i_item_id
 ...
 and d_date between cast('2002-05-21' as date) and date_add(cast('2002-05-21' as date), interval 60 day)
 and i_manufact_id in (682,776,785,883)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between date_sub(cast ('1998-02-14' as date), interval 30 day)
                and date_add(cast ('1998-02-14' as date), interval 30 day) 
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 776 and 776+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'bisque' or i_color = 'dark') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('snow','bisque','dodger'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 4
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('hot','turquoise','snow','beige','mint','steel') and
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 52255 and 52255+28800 
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-10' as date) 
                  and date_add(cast('2001-08-10' as date), interval 30 day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-07-23' as date) and date_add(cast('1998-07-23' as date), interval 60 day)
 and i_manufact_id in (475,408,976,863)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-07-20','1999-10-10','1999-11-10')))
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Waterloo'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  23824
   and ib_upper_bound   <=  23824 + 50000
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Electronics','Men','Shoes') and
          i_class in ('camcorders','sports-apparel','mens')
         )
      or (i_category in ('Music','Children','Women') and
          i_class in ('rock','toddlers','swimwear') 
        ))
...
and d_date between '2001-03-06' and 
        date_add(cast('2001-03-06' as date), interval 90 day)
...
where 
	...
	and d_date between cast('1998-01-02' as date)
        and date_add(cast('1998-01-02' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
