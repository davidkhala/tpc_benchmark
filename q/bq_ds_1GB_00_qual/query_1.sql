...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-08' as date) 
                  and DATE_ADD(cast('1998-08-08' as date), interval 14 day)
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '39241','72015','77898','45794','75947','86218',
                          '12510','20721','39864','96914','54778',
                          '33755','97053','83513','70370','97171',
                          '92583','83385','61904','58455','91924',
                          '98588','78348','66472','28859','61735',
                          '41435','46771','80645','85188','10435',
                          '12831','42849','30181','63943','78500',
                          '79543','64929','64609','39342','65907',
                          '33990','61246','90061','89326','30435',
                          '48899','85467','76993','18953','79674',
                          '75793','41961','89466','18258','89925',
                          '96034','76622','75204','34920','22104',
                          '64227','16908','18653','94055','36753',
                          '39361','40678','96827','57147','24315',
                          '47852','37033','10005','33556','16127',
                          '99437','73485','40840','78553','93566',
                          '74369','22717','93652','87612','91944',
                          '54179','39332','27849','28257','25071',
                          '52984','49647','26009','61888','28037',
                          '25649','56640','50187','51560','17402',
                          '79886','41298','82985','91730','17857',
                          '77908','72751','10814','94729','24360',
                          '92393','35301','90410','56506','31848',
                          '20827','91171','54368','23050','29893',
                          '80541','42014','63474','20561','74984',
                          '88754','71909','64610','30889','43886',
                          '81240','26530','85715','59687','52930',
                          '35559','80853','74537','14144','58280',
                          '79720','58321','46184','15100','42055',
                          '88246','16929','84746','88658','16118',
                          '37370','57608','22429','43774','44765',
                          '26142','31742','45247','79389','11250',
                          '96111','91523','65276','78115','75547',
                          '50222','19990','89598','34363','78574',
                          '34674','78197','87156','64402','53156',
                          '87994','43416','93044','88178','63603',
                          '29414','71336','93351','18894','18715',
                          '56482','86687','61311','24038','71190',
                          '28928','52841','64682','47241','62496',
                          '14304','68522','82199','48156','82817',
                          '73220','61471','72753','48078','64564',
                          '53151','19666','86288','11538','90626',
                          '68927','32941','99362','45065','82476',
                          '22554','50199','87246','55150','41133',
                          '41206','78353','28442','82496','17930',
                          '18385','21548','73108','11258','86931',
                          '41125','42841','71890','61209','40277',
                          '75427','53039','65490','44450','17677',
                          '42172','14384','40471','17513','11928',
                          '90118','70578','83452','71824','61488',
                          '19464','78097','64277','73933','40695',
                          '60315','21321','44493','89123','27921',
                          '74911','86372','82781','79785','96779',
                          '77834','81718','22611','74534','25584',
                          '54471','16278','49300','55907','38314',
                          '59656','47488','12823','34616','80902',
                          '83588','88355','97786','98872','50205',
                          '48751','59389','39034','16371','74077',
                          '30135','43479','53956','28985','45357',
                          '17966','97797','56527','16621','92730',
                          '71952','42280','43264','61190','14710',
                          '57733','84311','26892','28959','99317',
                          '42347','92100','85496','31770','36573',
                          '20061','37634','51228','39495','66709',
                          '51581','94744','17734','54876','94776',
                          '51383','26671','44192','33405','93086',
                          '97056','61754','65992','27701','26552',
                          '34680','16252','94926','47936','75761',
                          '12994','64260','97130','99539','15229',
                          '49354','64730','10362','93607','89946',
                          '93240','84878','85361','78904','23777',
                          '57387','15413','35418','57745','40808',
                          '17400','64780','97956','27400','48333',
                          '97430','66501','49032','50415','37032',
                          '49175','32161','69312','86873','11536',
                          '28040','17562','41589','10797','40872',
                          '17534','98748','91986','35169','31099',
                          '90786','21728','84111','22354','77144',
                          '74475','57212','58742','98735','25945',
                          '19994','19057','29558','50198')
     intersect distinct
      select ca_zip
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 14743
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 3402
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 37649
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 15417
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 6913
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
select  
 ...
 where
  ...
  ca_county in ('Chowan County','Elko County','Camden County','Panola County','Saline County') and
...
where 
	...
	and d_date between cast('2001-01-19' as date) 
        and date_add(cast('2001-01-19' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (4,5,7,6,11,9) and
       d_year = 2001 and
       ca_state in ('GA','IN','FL'
                   ,'KY','PA','OK','MT')
...
select  i_item_id
 ...
 and d_date between cast('2000-02-06' as date) 
        and date_add(cast('2000-02-06' as date), interval 30 day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between date_sub(cast ('2001-04-12' as date), interval 30 day)
                    and date_add(cast ('2001-04-12' as date), interval 30 day)
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 26 and 26+10
          or ss_coupon_amt between 16829 and 16829+1000
...
and d_date between '2001-03-03' and 
        date_add(cast('2001-03-03' as date), interval 90 day)
...
select  i_item_id
 ...
 and d_date between cast('2000-06-27' as date) and date_add(cast('2000-06-27' as date), interval 60 day)
 and i_manufact_id in (823,667,856,959)
 ...
 where i_manufact_id between 687 and 687+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'maroon' or i_color = 'sandy') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('magenta','floral','pale'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 7
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('gainsboro','sienna','navajo','powder','cornsilk','lawn') and
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 51506 and 51506+28800 
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-04' as date) 
                  and date_add(cast('2000-08-04' as date), interval 30 day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-05-03' as date) and date_add(cast('1998-05-03' as date), interval 60 day)
 and i_manufact_id in (358,372,973,333)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-05-15','2000-09-04','2000-11-14')))
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Hamilton'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  7724
   and ib_upper_bound   <=  7724 + 50000
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (2002) and
        ((i_category in ('Home','Books','Men') and
          i_class in ('furniture','travel','shirts')
         )
      or (i_category in ('Music','Children','Sports') and
          i_class in ('classical','newborn','pools') 
        ))
...
and d_date between '2000-01-19' and 
        date_add(cast('2000-01-19' as date), interval 90 day)
...
where 
	...
	and d_date between cast('2001-04-20' as date)
        and date_add(cast('2001-04-20' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
