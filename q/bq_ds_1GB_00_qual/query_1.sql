 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '31541','76732','75947','95548','12510','90054',
                          '39864','18917','54778','82641','57307',
                          '45212','22974','97171','75631','83385',
                          '88664','58455','91924','50223','78348',
                          '63862','19362','28045','96234','57962',
                          '19050','13879','40618','75342','48843',
                          '50176','63943','80570','40721','19279',
                          '63816','70546','44042','33990','30467',
                          '21883','87460','71758','15713','40602',
                          '10626','92141','55084','90290','63956',
                          '98563','43876','19988','17806','29615',
                          '44464','32523','22104','40799','52708',
                          '18653','10560','36753','41997','94402',
                          '62982','67240','24315','60178','37033',
                          '54070','59516','24753','41118','48226',
                          '79219','13180','59063','74369','90829',
                          '93652','21669','91944','92064','30805',
                          '27849','72100','35605','98627','44689',
                          '71456','80984','99530','66569','61625',
                          '51803','40629','85403','79886','41298',
                          '68936','26708','43699','34239','28687',
                          '77904','49060','83976','77100','20857',
                          '90410','65682','79378','13204','54447',
                          '54368','18965','29893','80541','32554',
                          '63474','79147','70029','88754','36963',
                          '49051','30889','38682','18954','54544',
                          '65139','67335','23238','28654','12588',
                          '74537','58576','58280','32938','45238',
                          '46184','35353','42055','75733','31835',
                          '35782','81039','15287','70067','80737',
                          '26610','43528','19588','26142','82694',
                          '25387','45533','12197','55743','75293',
                          '84409','78115','75547','26873','44925',
                          '31242','16328','58417','78500','36770',
                          '94060','30246','83589','66218','20348',
                          '93044','62551','63603','20867','21821',
                          '13377','23487','56633','91933','93244',
                          '57979','51224','71190','86765','40367',
                          '32083','27832','30489','95845','17269',
                          '31957','46768','65701','72065','19381',
                          '75140','48078','94433','57497','26573',
                          '47729','11538','42499','97176','40172',
                          '17320','67409','67459','50850','23014',
                          '87246','84920','45868','26584','54230',
                          '95333','78528','84430','37849','41452',
                          '28682','74322','64008','93236','40800',
                          '69677','61209','83213','75427','94282',
                          '65490','37268','72209','17367','35856',
                          '62370','45063','46542','18904','18677',
                          '80188','92086','61488','19464','78097',
                          '33169','98994','89044','63119','20110',
                          '77111','37651','19541','84526','68385',
                          '33754','47407','82987','66641','77660',
                          '75509','20226','33612','68671','86055',
                          '49300','36527','24804','39038','75334',
                          '47801','34616','52909','59648','65950',
                          '63856','61271','26402','73176','16195',
                          '92792','88671','21846','90526','31982',
                          '53956','53217','54111','35126','49037',
                          '60784','75694','92730','58202','42280',
                          '37232','98955','39802','51878','84155',
                          '55338','23893','47261','95871','45366',
                          '25654','12921','58117','89812','41470',
                          '55626','37397','80545','58022','76877',
                          '43702','31170','11643','90520','42983',
                          '56372','68587','22629','23398','72379',
                          '65992','27701','26552','12289','38470',
                          '13010','79933','75761','37892','12333',
                          '12102','91789','98645','49354','44076',
                          '10362','94628','89946','11052','34336',
                          '83603','26023','51289','79660','10131',
                          '29252','76833','82116','36449','66221',
                          '13793','27400','62314','10935','30256',
                          '47855','81725','74583','18460','37724',
                          '90045','20624','48600','49231','63933',
                          '95980','45725','76712','54795','98748',
                          '91986','66416','35029','44713','53443',
                          '84111','28647','91954','23156','68863',
                          '51709','64125','62851','22470','46217',
                          '20132','32994','92039','20737')
     intersect distinct
      select ca_zip
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 47586
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 3765
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 41121
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 36462
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 11149
            then (select avg(ss_ext_tax)
                  from store_sales
...
select  
 ...
 where
  ...
  ca_county in ('Wabash County','Irion County','Monroe County','Adams County','Warren County') and
...
where 
	...
	and d_date between cast('2002-04-02' as date) 
        and date_add(cast('2002-04-02' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('VA', 'TN', 'MT')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OK', 'GA', 'CA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OH', 'KS', 'IN')
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (11,9,5,2,7,10) and
       d_year = 1999 and
       ca_state in ('NE','KY','PA'
                   ,'IN','TX','MT','NY')
...
select  i_item_id
 ...
 and d_date between cast('2001-02-28' as date) 
        and date_add(cast('2001-02-28' as date), interval 30 day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between date_sub(cast ('1999-02-21' as date), interval 30 day)
                    and date_add(cast ('1999-02-21' as date), interval 30 day)
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 160 and 160+10
          or ss_coupon_amt between 10012 and 10012+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 23 and 23+10
          or ss_coupon_amt between 13213 and 13213+1000
...
and d_date between '1998-03-16' and 
        date_add(cast('1998-03-16' as date), interval 90 day)
...
select  i_item_id
 ...
 and d_date between cast('2000-04-02' as date) and date_add(cast('2000-04-02' as date), interval 60 day)
 and i_manufact_id in (936,721,752,809)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between date_sub(cast ('2002-03-03' as date), interval 30 day)
                and date_add(cast ('2002-03-03' as date), interval 30 day) 
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('black','snow','salmon'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 2
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('indian','deep','slate','pale','ghost','goldenrod') and
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 6274 and 6274+28800 
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-02' as date) 
                  and date_add(cast('1998-08-02' as date), interval 30 day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-11' as date) 
                  and date_add(cast('2000-08-11' as date), interval 30 day)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-06-07' as date) and date_add(cast('1999-06-07' as date), interval 60 day)
 and i_manufact_id in (525,579,432,706)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-01-22','2000-08-25','2000-11-11')))
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Sunnyside'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  43734
   and ib_upper_bound   <=  43734 + 50000
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Women','Sports','Electronics') and
          i_class in ('maternity','optics','wireless')
         )
      or (i_category in ('Children','Shoes','Music') and
          i_class in ('newborn','athletic','country') 
        ))
...
and d_date between '2001-03-13' and 
        date_add(cast('2001-03-13' as date), interval 90 day)
...
where 
	...
	and d_date between cast('1999-01-14' as date)
        and date_add(cast('1999-01-14' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
