...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-21' as date) 
                  and DATE_ADD(cast('2002-08-21' as date), interval 14 day)
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '45191','18724','41715','86628','56591','23277',
                          '23974','35096','72604','63003','31311',
                          '17163','49221','28853','56077','55298',
                          '95834','96885','61918','88298','80624',
                          '78231','15397','38415','31298','37282',
                          '22007','84137','61770','12498','55021',
                          '29468','67539','83600','11428','75359',
                          '50914','44456','63930','53115','94060',
                          '90957','88415','95342','71635','21293',
                          '86570','47967','19545','33014','21234',
                          '82982','77023','61695','86969','52518',
                          '90921','95456','99215','94045','32489',
                          '73215','72570','89256','89280','81226',
                          '59227','58266','10844','55910','52304',
                          '88623','50419','64939','67365','56512',
                          '82466','70990','15363','60428','98895',
                          '33083','23988','86026','57830','95130',
                          '66955','39289','68089','26307','30842',
                          '90748','99616','29333','74374','56921',
                          '26407','62447','89274','19154','39885',
                          '20990','39225','56369','35530','56790',
                          '97111','17061','51272','50753','94829',
                          '19122','44503','57022','53973','19520',
                          '33202','55035','75861','17828','52687',
                          '20189','77086','88856','10942','22645',
                          '74219','47369','29166','60675','10082',
                          '26438','54029','52127','93553','14055',
                          '93930','88156','16317','80081','36291',
                          '92593','78198','47312','23706','33815',
                          '30586','84931','36632','36155','87434',
                          '77789','79539','27499','68455','30457',
                          '92398','55374','46392','64018','50160',
                          '46974','99144','23029','85027','58056',
                          '99664','65471','68105','52880','49628',
                          '55060','55691','47023','59392','27294',
                          '96731','54276','34869','73709','83748',
                          '58731','33510','37241','82425','26876',
                          '65211','14244','44485','23911','54649',
                          '36527','13731','89767','32386','98105',
                          '87094','46515','97156','99984','99581',
                          '20086','82434','44287','10706','80256',
                          '73862','68787','62614','83856','52665',
                          '36518','16901','87308','87048','41548',
                          '34184','35688','95628','42866','83855',
                          '76078','35886','68940','62741','63478',
                          '91610','19074','33786','74541','83261',
                          '79975','88523','48035','14241','87245',
                          '13740','45848','40382','75663','38938',
                          '73626','14864','13902','78179','44036',
                          '40972','68962','61439','41217','77322',
                          '83907','79351','84489','28128','20243',
                          '62151','80674','28779','30478','57385',
                          '77235','78501','93417','46196','76418',
                          '19925','31574','89000','32291','85599',
                          '93874','37582','87522','59473','38144',
                          '89786','70080','83592','90438','78440',
                          '83549','83541','46259','76098','42970',
                          '35516','53116','70807','89287','97928',
                          '26387','63053','17814','95302','35222',
                          '83489','15552','11490','79418','17987',
                          '36801','47555','99442','66335','37329',
                          '55401','80995','37655','47246','29343',
                          '57248','88656','58668','38078','48413',
                          '83481','77714','30538','54895','74779',
                          '25106','78028','74428','63527','14501',
                          '79186','21990','14317','90627','53575',
                          '28930','34852','27276','23693','57523',
                          '14153','37996','66346','73694','42183',
                          '28070','67135','46531','75177','57075',
                          '53910','92490','60355','55366','70215',
                          '35035','81069','33427','30699','86734',
                          '41954','33431','51954','26420','59705',
                          '48133','76915','95099','70755','66290',
                          '49579','47863','19745','45119','63965',
                          '41101','82214','57096','37404','68399',
                          '15482','47586','33396','34152','53012',
                          '76612','59777','65095','72379','75415',
                          '55117','65916','44058','74957','80245',
                          '61984','49351','41597','29018','97138',
                          '86253','18344','98489','28313')
     intersect distinct
      select ca_zip
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 40333
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 29343
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 16629
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 26682
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 16504
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
select  
 ...
 where
  ...
  ca_county in ('Lafayette County','Matanuska-Susitna Borough','Crisp County','Louisa County','Rosebud County') and
...
where 
	...
	and d_date between cast('2001-05-03' as date) 
        and date_add(cast('2001-05-03' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('TN', 'AR', 'UT')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NM', 'PA', 'AZ')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('GA', 'WV', 'IL')
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (6,11,10,2,9,8) and
       d_year = 2000 and
       ca_state in ('MI','IA','ND'
                   ,'KY','NE','WV','OH')
...
select  i_item_id
 ...
 and d_date between cast('1998-04-28' as date) 
        and date_add(cast('1998-04-28' as date), interval 30 day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between date_sub(cast ('2000-04-28' as date), interval 30 day)
                    and date_add(cast ('2000-04-28' as date), interval 30 day)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 118 and 118+10 
             or ss_coupon_amt between 4679 and 4679+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 72 and 72+10
          or ss_coupon_amt between 1701 and 1701+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 171 and 171+10
          or ss_coupon_amt between 10834 and 10834+1000
...
and d_date between '1999-02-10' and 
        date_add(cast('1999-02-10' as date), interval 90 day)
...
select  i_item_id
 ...
 and d_date between cast('2001-02-18' as date) and date_add(cast('2001-02-18' as date), interval 60 day)
 and i_manufact_id in (889,888,782,913)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between date_sub(cast ('2002-06-03' as date), interval 30 day)
                and date_add(cast ('2002-06-03' as date), interval 30 day) 
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 751 and 751+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'olive' or i_color = 'burnished') and
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'blue' or i_color = 'bisque') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('white','tan','lime'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 5
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('floral','hot','yellow','cream','slate','rosy') and
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 53664 and 53664+28800 
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-24' as date) 
                  and date_add(cast('2000-08-24' as date), interval 30 day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-27' as date) 
                  and date_add(cast('2001-08-27' as date), interval 30 day)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-05-21' as date) and date_add(cast('2001-05-21' as date), interval 60 day)
 and i_manufact_id in (681,951,435,173)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-04-08','2000-08-13','2000-11-07')))
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Greenville'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  17761
   and ib_upper_bound   <=  17761 + 50000
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Jewelry','Children','Books') and
          i_class in ('earings','infants','travel')
         )
      or (i_category in ('Women','Shoes','Sports') and
          i_class in ('fragrances','womens','camping') 
        ))
...
where 
	...
	and d_date between cast('2002-04-11' as date)
        and date_add(cast('2002-04-11' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
