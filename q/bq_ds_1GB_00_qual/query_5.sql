 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '45547','42485','63232','98173','85157','59613',
                          '75132','54620','69470','19192','55398',
                          '35565','16344','80037','74793','77339',
                          '51103','47398','37028','78225','66025',
                          '32889','83709','40938','95880','88148',
                          '57360','65893','32254','30543','50444',
                          '91060','17315','19089','60100','26068',
                          '71973','74891','54420','42994','85820',
                          '99022','54822','95098','40790','51690',
                          '29657','33112','34478','72132','81091',
                          '44778','91910','56310','22318','95801',
                          '76243','84120','92321','61060','29661',
                          '16513','41429','99165','66559','75048',
                          '66220','52890','22949','78330','47703',
                          '90329','49293','72081','12515','36188',
                          '26452','88539','50336','60090','33139',
                          '25156','54307','44281','15537','26704',
                          '42634','87424','16000','48380','11286',
                          '85658','42396','78184','83280','31515',
                          '19108','74152','14089','74104','85151',
                          '84712','97246','28576','83189','13017',
                          '40985','50956','75971','41109','98339',
                          '77789','30897','82711','39135','33426',
                          '79219','89225','55233','44369','83310',
                          '21517','76371','95773','33597','49394',
                          '20725','24425','93218','64017','82640',
                          '22092','19137','41052','77386','92546',
                          '56977','23880','38479','81393','29017',
                          '81314','87570','11260','14577','63465',
                          '91416','89332','55409','60341','36698',
                          '16313','38415','72014','31041','99474',
                          '12288','64946','48365','19309','92872',
                          '57354','96405','27856','96373','41145',
                          '87593','34651','58857','75958','74029',
                          '94260','73851','16303','94602','82655',
                          '43799','98415','99377','22482','85556',
                          '95766','91642','99665','58272','37439',
                          '50794','92125','49738','53513','16270',
                          '10043','14333','50064','97427','42141',
                          '57399','51762','41406','90015','21564',
                          '62307','30603','21828','97704','75819',
                          '32361','33838','12074','97737','83020',
                          '61209','96626','15289','91044','30087',
                          '47745','19666','79766','68465','10233',
                          '30784','82375','85989','54523','87297',
                          '29407','31323','89217','29868','13578',
                          '22956','38934','47452','37159','12428',
                          '99561','75302','40552','20337','47956',
                          '35939','53886','58125','74525','14610',
                          '88187','34977','48257','40039','65051',
                          '39447','62202','26002','31457','22063',
                          '71718','12090','53284','37602','43952',
                          '74545','91013','18239','55452','62861',
                          '82431','84634','79543','36997','98879',
                          '60939','69500','51112','93606','89274',
                          '51236','99404','68947','52756','50045',
                          '73900','14428','91070','57841','61841',
                          '83615','65801','72864','89130','52337',
                          '28052','54606','71447','66039','16625',
                          '76603','24660','35135','58471','16061',
                          '86707','44621','32459','83296','95839',
                          '72728','23681','41352','73910','74811',
                          '97886','20958','64317','43373','61360',
                          '78208','84850','39147','39456','33542',
                          '19732','54548','87002','23898','33359',
                          '56702','37032','49091','36799','79985',
                          '31369','89462','81229','80715','27045',
                          '26280','26478','99965','38829','21847',
                          '77898','79676','86383','88284','74579',
                          '14534','89986','23346','94021','80420',
                          '28656','40954','34417','53740','69502',
                          '75372','50990','47384','81877','85621',
                          '85861','29345','46116','63015','78879',
                          '24717','85439','68501','92004','85124',
                          '76616','90282','59025','55212','43833',
                          '50714','46807','76392','27609','48636',
                          '84947','87179','52137','73020','68157',
                          '94895','75096','29003','61422','53865',
                          '60023','95358','39611','37664','66981',
                          '48333','39023','16104','40630')
     intersect distinct
      select ca_zip
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 36320
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 45227
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 3744
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 43386
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 38579
            then (select avg(ss_ext_list_price)
                  from store_sales
...
select  
 ...
 where
  ...
  ca_county in ('Chilton County','Seminole County','Butts County','Thomas County','Contra Costa County') and
...
where 
	...
	and d_date between cast('2000-02-03' as date) 
        and date_add(cast('2000-02-03' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('TN', 'NM', 'GA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'NY', 'AR')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OH', 'OR', 'AL')
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,6,7,9,4,2) and
       d_year = 1998 and
       ca_state in ('SC','CO','AK'
                   ,'VA','OH','KY','WI')
...
select  i_item_id
 ...
 and d_date between cast('1998-06-14' as date) 
        and date_add(cast('1998-06-14' as date), interval 30 day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between date_sub(cast ('1999-03-12' as date), interval 30 day)
                    and date_add(cast ('1999-03-12' as date), interval 30 day)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 26 and 26+10 
             or ss_coupon_amt between 15647 and 15647+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 63 and 63+10
          or ss_coupon_amt between 8606 and 8606+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 21 and 21+10
          or ss_coupon_amt between 16208 and 16208+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 69 and 69+10
          or ss_coupon_amt between 12950 and 12950+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 23 and 23+10
          or ss_coupon_amt between 15120 and 15120+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 189 and 189+10
          or ss_coupon_amt between 10622 and 10622+1000
...
and d_date between '2000-03-04' and 
        date_add(cast('2000-03-04' as date), interval 90 day)
...
select  i_item_id
 ...
 and d_date between cast('1998-04-28' as date) and date_add(cast('1998-04-28' as date), interval 60 day)
 and i_manufact_id in (807,827,924,920)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between date_sub(cast ('1999-04-30' as date), interval 30 day)
                and date_add(cast ('1999-04-30' as date), interval 30 day) 
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('misty','lavender','antique'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 5
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('almond','thistle','beige','firebrick','misty','peru') and
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 36274 and 36274+28800 
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-21' as date) 
                  and date_add(cast('2002-08-21' as date), interval 30 day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-05-30' as date) and date_add(cast('1999-05-30' as date), interval 60 day)
 and i_manufact_id in (220,649,533,831)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-06-09','1999-10-02','1999-11-19')))
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Riverside'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  68219
   and ib_upper_bound   <=  68219 + 50000
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Shoes','Books','Children') and
          i_class in ('mens','arts','toddlers')
         )
      or (i_category in ('Electronics','Men','Women') and
          i_class in ('monitors','shirts','maternity') 
        ))
...
and d_date between '2000-02-27' and 
        date_add(cast('2000-02-27' as date), interval 90 day)
...
where 
	...
	and d_date between cast('1999-04-11' as date)
        and date_add(cast('1999-04-11' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
