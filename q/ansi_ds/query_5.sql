...
select top 100 *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2000-04-28' as date) - 30 days)
...
select top 100 i_item_id
 ...
 and d_date between cast('2001-02-18' as date) and (cast('2001-02-18' as date) +  60 days)
...
select top 100 i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-05-21' as date) and (cast('2001-05-21' as date) +  60 days)
