...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-24' as date) 
                  and date_add(cast('1999-08-24' as date), interval 30 day)
       and ss_store_sk = s_store_sk
...
and d_date between '1998-02-09' and 
        date_add(cast('1998-02-09' as date), interval 90 day)
...
select  i_item_id
 ...
 and d_date between cast('1998-04-08' as date) and date_add(cast('1998-04-08' as date), interval 60 day)
...
where 
	...
	and d_date between cast('2002-01-16' as date)
        and date_add(cast('2002-01-16' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-01-23' as date) and date_add(cast('2000-01-23' as date), interval 60 day)
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between date_sub(cast ('2000-05-26' as date), interval 30 day)
                    and date_add(cast ('2000-05-26' as date), interval 30 day)
...
and d_date between '2002-01-27' and 
        date_add(cast('2002-01-27' as date), interval 90 day)
...
where 
	...
	and d_date between cast('1999-03-22' as date) 
        and date_add(cast('1999-03-22' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between date_sub(cast ('2001-02-26' as date), interval 30 day)
                and date_add(cast ('2001-02-26' as date), interval 30 day) 
