...
-- CATALOG_RETURNS, partition by cr_returned_date_sk
-- CATALOG_SALES, partition by cs_sold_date_sk
-- INVENTORY, partition by inv_date_sk
-- STORE_RETURNS, partition by sr_returned_date_sk
-- STORE_SALES, partition by ss_solid_date_sk 
-- WEB_RETURNS, partition by wr_returned_date_sk
-- WEB_SALES, partition by ws_sold_date_sk
-- 
