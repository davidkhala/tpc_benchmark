...
SELECT
  ...
  s_comment
FROM
  h_100GB_01_PART.part,
  h_100GB_01_PART.supplier,
  h_100GB_01_PART.partsupp,
  h_100GB_01_PART.nation,
  h_100GB_01_PART.region
WHERE
...
SELECT
  ...
  o_shippriority
FROM
  h_100GB_01_PART.customer,
  h_100GB_01_PART.orders,
  h_100GB_01_PART.lineitem
WHERE
...
FROM (
  ...
  FROM
    ...
    h_100GB_01_PART.orders,
    h_100GB_01_PART.customer,
    h_100GB_01_PART.nation n1,
    h_100GB_01_PART.nation n2
  WHERE
    s_suppkey = l_suppkey
...
CREATE VIEW
  `h_100GB_01_PART.49586899439487868_revenue_view` AS
SELECT
  l_suppkey AS supplier_no,
  SUM(l_extendedprice * (1 - l_discount)) AS total_revenue
FROM
  `tpc-benchmarking-9432.h_100GB_01_PART.lineitem`
WHERE
...
FROM
  h_100GB_01_PART.supplier,
  `h_100GB_01_PART.49586899439487868_revenue_view`
WHERE
